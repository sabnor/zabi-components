<script lang="ts">
    ...
    const textareaClasses = $derived(() => {
        const baseClasses =
            "w-full bg-base-200 rounded-lg transition-all duration-200 placeholder:text-description text-body focus:outline-none focus:ring-offset-0 disabled:opacity-50 disabled:cursor-not-allowed resize-y px-4 py-2.5 text-base leading-6";
