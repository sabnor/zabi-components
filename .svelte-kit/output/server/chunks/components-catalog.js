...
<Input variant="warning" label="Password" />`
  ...
  <p>Card content goes here</p>
    ...
    },
    {
      name: "List",
      category: "atoms",
      description: "Semantic `<ul>` built from `items` (`ListItemData`). Optional `icon`, `avatar`, `description`, `href`, `selectedId`, `showArrow`, and `className` on the container. For trailing badges or amounts, use `ListItem` with a `trailing` snippet (see `/components/List`).",
      props: [
        {
          name: "items",
          type: "ListItem[]",
          required: true,
          defaultValue: "[]",
          description: "Array of `ListItemData`: `id`, `label`, optional `description`, `href`, `icon`, `avatar`, `avatarAlt`, `disabled`, link `target` / `rel`"
        },
        {
          name: "ariaLabel",
          type: "string",
        ...
        },
        {
          ...
          required: false,
          defaultValue: "",
          description: "Additional Tailwind classes on the `<ul>` (e.g. border, padding, background)"
        },
        {
          name: "onclick",
      ...
      examples: [
        {
          ...
          description: "Pass `selectedId` to highlight the active row (e.g. current settings section)",
          code: `<List
  items={items}
  selectedId="billing"
...
/>`
        },
        {
          ...
          description: "Optional `icon` per `ListItemData` entry (Lucide or compatible component)",
          code: `<script lang="ts">
...
<List items={items} ariaLabel="Account" />`
        ...
        {
          title: "Arrow hidden",
          description: "Set `showArrow={false}` for compact rows without a chevron",
          code: `<List
  items={items}
  showArrow={false}
  ariaLabel="Options"
/>`
    ...
    },
    {
      name: "Checkbox",
      category: "atoms",
      description: "Checkbox input with label, focus ring, and controlled/uncontrolled checked state.",
      props: [
        {
          name: "id",
          type: "string",
    ...
    },
    {
      name: "Radio",
      category: "atoms",
      description: "Single radio input with label, focus ring, and controlled/uncontrolled checked state",
      props: [
        {
          name: "id",
          type: "string",
    ...
    },
    {
      ...
      props: [
        ...
        },
        {
          ...
          required: false,
          defaultValue: "false",
          description: 'When true, `code` is trusted highlighter HTML (e.g. `<span class="token">`). When false, `code` is escaped plain source.'
        },
        {
          name: "language",
          type: "string",
  ...
  return 'Hello';
        ...
        },
        {
          ...
          description: "Pass `trustHtml` when `code` contains markup from your highlighter",
    ...
    },
    {
      name: "FeatureCard",
      category: "atoms",
      description: "Minimal, Stripe-inspired card for marketing and overview sections. Composable via snippets.",
      props: [
        {
          name: "title",
          type: "string",
        ...
        },
        {
          ...
          required: false,
          defaultValue: "",
          description: "Icon component rendered in the top slot. Pass a Lucide icon directly, e.g. `icon={ShieldCheck}`."
        },
        {
          name: "children",
          type: "Snippet",
          required: false,
          defaultValue: "",
          description: "Optional footer content, e.g. a learn-more link or CTA."
        },
        {
          name: "class",
          type: "string",
      ...
      examples: [
        ...
        },
        {
          ...
          description: "Pass a Lucide icon component directly via the `icon` prop",
    ...
    },
    {
      ...
      props: [
        {
          ...
          required: false,
          defaultValue: "'text'",
          description: "Shape preset. `text` is a short rounded bar for lines of copy, `circle` is a square with full rounding for avatars and icon placeholders, `block` is a taller rectangle for media, cards, and hero regions."
        },
        {
          name: "width",
          type: "string | number",
          ...
          description: "Explicit width as a CSS length (e.g. `'50%'`, `'12rem'`) or pixel number. Omit to fill the parent, or pass a fixed Tailwind width via `class` (e.g. `w-64`)."
        },
        {
          name: "height",
          type: "string | number",
          ...
          description: "Explicit height as a CSS length or pixel number. Defaults: text ≈ 0.75rem, circle matches width, block ≈ 8rem."
        },
        {
          name: "class",
          type: "string",
          required: false,
          defaultValue: "''",
          description: "Extra classes forwarded to the root element. Useful for fixed Tailwind widths, rounding overrides, or margins."
        },
        {
          name: "aria-label",
          type: "string",
          ...
          description: "Label announced by assistive tech. Keep the default for generic loading, or set to something more specific (e.g. `'Loading profile'`) when the skeleton stands in for a named region."
        }
      ],
      ...
      examples: [
        {
          title: "Text line",
          description: "Default variant. Fills the parent width and stands in for a single line of copy.",
          code: "&lt;Skeleton /&gt;"
        },
        {
          title: "Avatar",
          description: "Circle variant — a perfect square with full rounding, sized for avatars and icon buttons.",
          code: '&lt;Skeleton variant="circle" /&gt;'
        },
        {
          title: "Media block",
          description: "Block variant for images, video thumbnails, cover art, and card headers. Fills the parent by default.",
          code: '&lt;Skeleton variant="block" /&gt;'
        },
        {
          title: "Custom size",
          description: "Use the `width` / `height` props for CSS lengths or pixel values, or `class` for a fixed Tailwind utility.",
          code: '&lt;Skeleton width="50%" /&gt;\n&lt;Skeleton width={240} height={8} /&gt;\n&lt;Skeleton variant="block" class="w-64" /&gt;'
        },
        {
          title: "User row",
          description: "Classic list-row pattern: avatar beside two stacked text lines of varying length. Wrap the text column in `flex-1` so it adapts to the row width.",
          code: '&lt;div class="flex items-center gap-3"&gt;\n  &lt;Skeleton variant="circle" /&gt;\n  &lt;div class="flex-1 space-y-2"&gt;\n    &lt;Skeleton variant="text" width="60%" /&gt;\n    &lt;Skeleton variant="text" width="40%" /&gt;\n  &lt;/div&gt;\n&lt;/div&gt;'
        },
        {
          title: "Article card",
          description: "Media block above a title and description — a drop-in placeholder for feed cards, blog previews, and product tiles.",
    ...
    },
    {
      name: "Toast",
      category: "atoms",
      description: "Toast atom for a single surface; use the Toaster molecule plus pushToast() for stacked app notifications with countdown and expandable detail.",
      props: [
        {
          name: "message",
          type: "string",
        ...
        },
        {
          ...
          description: "viewport: fixed corner toast; inline: block width up to max (for demos inside a sized parent)"
        }
      ],
      ...
      examples: [
        {
          ...
          description: "Mount once in the app shell; pushToast() queues notifications shown here (bottom-right).",
        ...
        },
        {
          ...
          description: 'Use layout="inline" for docs and embedded UI; default layout="viewport" pins a single toast to the corner.',
          code: '&lt;div class="max-w-md"&gt;\n  &lt;Toast layout="inline" type="success" message="Operation completed" /&gt;\n&lt;/div&gt;'
        },
        {
          title: "Semantic types",
          description: "type sets border and text: success, error, warning, or info.",
    ...
    },
    {
      name: "Table",
      category: "atoms",
      description: "Scrollable `<table>` shell with optional caption; pass `<thead>` / `<tbody>` as children.",
      props: [
        {
          name: "caption",
          type: "string",
  ...
  <tbody>…</tbody>
    ...
    },
    {
      name: "Toggle",
      category: "atoms",
      description: "Accessible switch-style toggle with optional label and loading state.",
      props: [
        {
          name: "checked",
          type: "boolean",
    ...
    },
    {
      name: "Textarea",
      category: "atoms",
      description: "Multi-line field with label, semantic variants, and validation message slot.",
      props: [
        {
          name: "value",
          type: "string",
    ...
    },
    {
      name: "Progress",
      category: "atoms",
      description: "Determinate progress bar with optional label and percentage readout.",
      props: [
        {
          name: "value",
          type: "number",
    ...
    },
    {
      name: "CardHeader",
      category: "atoms",
      description: "Card header with title, subtitle, description, and optional snippet content.",
      props: [
        {
          name: "title",
          type: "string",
    ...
    },
    {
      name: "ThemeToggle",
      category: "atoms",
      description: "Sun/moon control that syncs with `document.documentElement` dark class and storage.",
      props: [
        {
          name: "size",
          type: "'sm' | 'md' | 'lg'",
    ...
    },
    {
      name: "Divider",
      category: "atoms",
      description: "Horizontal or vertical separator; optional inset and label.",
      props: [
        {
          name: "orientation",
    ...
    },
    {
      name: "Container",
      category: "atoms",
      description: "Centered max-width wrapper with optional horizontal padding.",
      props: [
        {
          name: "as",
    ...
    },
    {
      name: "Text",
      category: "atoms",
      description: "Typography primitive with tone and size tokens (`p`, `span`, or `div`).",
      props: [
        {
          name: "as",
          type: "'p' | 'span' | 'div'",
    ...
    },
    {
      name: "ActionPanel",
      category: "atoms",
      description: "Clickable or link card for primary actions with optional badge.",
      props: [
        {
          name: "title",
          type: "string",
  ...
  molecules: [
    ...
    },
    {
      name: "Toaster",
      category: "molecules",
      description: "Fixed notification region; pair with `pushToast()` from `toast-store`. Mount once near the app root.",
      props: [
        {
          name: "class",
          type: "string",
    ...
    },
    {
      name: "RadioGroup",
      category: "molecules",
      description: "Fieldset-based radio group with optional legend; uses native radios with shared `name`.",
      props: [
        {
          name: "options",
...
/>`
    ...
    },
    {
      name: "FormField",
      category: "molecules",
      description: "Accessible field wrapper: label, description, error, and a `control` snippet for the input.",
      props: [
        {
          name: "label",
          type: "string",
  ...
  {/snippet}
    ...
    },
    {
      name: "Header",
      category: "molecules",
      description: "Documentation-style page header: title, description, category badge, and variant chips.",
      props: [
        {
          name: "title",
          type: "string",
    ...
    },
    {
      name: "EmptyState",
      category: "molecules",
      description: "Centered empty state with title, description, and optional action/media snippets.",
      props: [
        {
          name: "title",
          type: "string",
    ...
    },
    {
      name: "Section",
      category: "molecules",
      description: "Section with optional title, background, padding, and max-width for marketing layouts.",
      props: [
        {
          name: "title",
          type: "string",
    ...
    },
    {
      ...
      category: "molecules",
      description: "Horizontal menubar list; use inside `NavigationMenu` with items and triggers.",
      props: [
        {
          name: "className",
          type: "string",
    ...
    },
    {
      ...
      category: "molecules",
      description: "Brand row for sidebars: logo, wordmark, or collapsed monogram.",
      props: [
        {
          name: "brandName",
          type: "string",
    ...
    },
    {
      name: "SidebarFooter",
      category: "molecules",
      description: "Sidebar footer with profile chip, theme toggle, and logout; wires optional account panel.",
      props: [
        {
          name: "profileName",
          type: "string",
    ...
    },
    {
      ...
      category: "molecules",
      description: "Grouped list section with optional heading and required list aria-label.",
      props: [
        {
          name: "title",
          type: "string",
    ...
    },
    {
      name: "ComponentDemo",
      category: "molecules",
      description: "Doc helper: Card with title, preview/code toggle, and syntax-highlighted snippet.",
      props: [
        {
          name: "title",
          type: "string",
  ...
  organisms: [
    ...
    },
    {
      ...
      category: "organisms",
      description: "Sidebar navigation with optional Daybridge-style card layout, section labels, brand row, collapsed/expanded modes, grouped links, badges, and utility controls.",
      props: [
        {
          name: "mode",
    ...
    },
    {
      name: "SidebarPanel",
      category: "organisms",
      description: "Companion panel for sidebar search-trigger flows: searchable list, selection, badges, and close control; elevated variant matches card sidebars.",
      props: [
        {
          name: "variant",
          type: '"plain" | "elevated"',
    ...
    },
    {
      ...
      category: "organisms",
      description: "Account picker panel: profile, theme row, and logout; composes `SidebarPanel` with fixed actions.",
      props: [
        {
          name: "profileName",
          type: "string",
      ...
      examples: [
        {
          title: "Account panel",
          description: "Opens from SidebarNavigation profile control",
