...
import { I as Input, L as Layout, B as Badge, C as ComponentDemo, A as Alert } from "../../chunks/Badge.js";
...
function FeatureCard($$renderer, $$props) {
  ...
  $$renderer.push(`<div${attributes(
    {
      class: `feature-card p-6 rounded-lg bg-surface border border-border hover:border-primary/20 transition-colors duration-200 ${stringify(className)}`,
      ...restProps
    },
    "svelte-ecbnw5"
  ...
  $$renderer.component(($$renderer2) => {
    ...
    Layout($$renderer2, {
      ...
      $$slots: {
        ...
        main: ($$renderer3) => {
          $$renderer3.push(`<div slot="main" class="container mx-auto p-6 space-y-16"><section class="py-20 px-4 text-center"><div class="max-w-4xl mx-auto"><h1 class="text-5xl md:text-6xl font-bold text-text mb-6">Zabi Components</h1> <p class="text-xl md:text-2xl text-text-secondary mb-8">Clean, minimal Svelte 5 components that just work</p> <p class="text-lg text-text-secondary/80 max-w-2xl mx-auto mb-12">Build beautiful, accessible user interfaces with our
          ...
          $$renderer3.push(`<!----></div> <div class="mt-8 flex justify-center">`);
          Badge($$renderer3, {
            variant: "info",
            className: "text-sm",
            children: ($$renderer4) => {
              $$renderer4.push(`<!---->v4.0.0 - Svelte 5 Ready`);
            }
          });
          $$renderer3.push(`<!----></div></div></section> <section class="py-16"><div class="text-center mb-12"><h2 class="text-3xl font-bold text-text mb-4">Why Choose Zabi Components?</h2> <p class="text-lg text-text-secondary max-w-2xl mx-auto">Built with modern web standards and developer experience in
          ...
          $$renderer3.push(`<!--]--></div></section> <section class="py-16"><div class="text-center mb-12"><h2 class="text-3xl font-bold text-text mb-4">See It In Action</h2> <p class="text-lg text-text-secondary max-w-2xl mx-auto">Interactive examples of our most popular components</p></div> <div class="space-y-8">`);
...
<Button variant="brand">Brand Button</Button>`,
            children: ($$renderer4) => {
              $$renderer4.push(`<div class="flex flex-wrap gap-4 items-center">`);
              Button($$renderer4, {
                variant: "primary",
                size: "lg",
                children: ($$renderer5) => {
  ...
  This card indicates an error state.
            ...
            children: ($$renderer4) => {
              ...
              Card($$renderer4, {
                ...
                variant: "default",
                children: ($$renderer5) => {
                  $$renderer5.push(`<p class="text-text-secondary">This is a default card with clean styling.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer4.push(`<!----> `);
              Card($$renderer4, {
                ...
                variant: "success",
                children: ($$renderer5) => {
                  $$renderer5.push(`<p class="text-text-secondary">This card indicates a successful action.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer4.push(`<!----> `);
              Card($$renderer4, {
                ...
                variant: "warning",
                children: ($$renderer5) => {
                  $$renderer5.push(`<p class="text-text-secondary">This card shows a warning state.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer4.push(`<!----> `);
              Card($$renderer4, {
                ...
                variant: "error",
                children: ($$renderer5) => {
                  $$renderer5.push(`<p class="text-text-secondary">This card indicates an error state.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer4.push(`<!----></div>`);
