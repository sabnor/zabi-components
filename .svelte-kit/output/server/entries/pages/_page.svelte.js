...
import { N as Navigation, T as ThemeToggle, B as Button, C as Card, a as CardHeader, b as CardContent } from "../../chunks/CodeBlock.svelte_svelte_type_style_lang.js";
import { g as generateId, C as ComponentDemo, I as Input, A as Alert, B as Badge, a as Checkbox, S as Select, T as Textarea, b as Tabs, M as Modal, D as Dropdown, c as Tooltip, d as Skeleton, e as SidebarNavigation, H as House, f as Chart_column, h as Bell, i as Chart_pie, P as Package, j as Settings, k as ContactForm } from "../../chunks/SidebarNavigation.js";
...
function _page($$renderer, $$props) {
  $$renderer.component(($$renderer2) => {
    ...
    let activeTab = "tab1";
    let sidebarCurrentPath = "/revenue";
    let sidebarLightMode = false;
    ...
    function handleSidebarNavigate(item, event) {
    ...
    function $$render_inner($$renderer3) {
      head("1uha8ag", $$renderer3, ($$renderer4) => {
        $$renderer4.title(($$renderer5) => {
          $$renderer5.push(`<title>Zabi Components - Easy-to-Use Design System</title>`);
        });
        $$renderer4.push(`<meta name="description" content="An easy-to-use design system built with Svelte and Tailwind CSS. Beautiful, accessible components that just work."/>`);
      });
      $$renderer3.push(`<div class="min-h-screen bg-background"><header class="sticky top-0 z-50 w-full border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60"><div class="container mx-auto flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8"><h1 class="text-xl font-bold text-headline">Zabi Components</h1> <div class="flex items-center gap-4">`);
      Navigation($$renderer3, { variant: "header", items: navItems });
      $$renderer3.push(`<!----> `);
      ThemeToggle($$renderer3, {});
      $$renderer3.push(`<!----></div></div></header> <main class="container mx-auto px-4 sm:px-6 lg:px-8"><section class="py-24 sm:py-32"><div class="mx-auto max-w-4xl text-center"><div class="mb-8 inline-flex items-center rounded-full border border-border bg-base-50 px-4 py-2 text-sm text-description"><span class="mr-2">⚡</span> <span>Built with Svelte 5 &amp; Tailwind CSS</span></div> <h1 class="text-5xl font-bold tracking-tight text-headline sm:text-6xl md:text-7xl mb-6">Your Easy-to-Use <span class="text-brand-700">Design System</span></h1> <p class="text-xl text-description mb-8 sm:text-2xl">Beautifully designed components built with Svelte and
      ...
      for (let $$index = 0, $$length = each_array.length; $$index < $$length; $$index++) {
        ...
        Card($$renderer3, {
          ...
          fullWidth: true,
          children: ($$renderer4) => {
            $$renderer4.push(`<div class="flex items-start gap-4"><div class="text-3xl flex-shrink-0" aria-hidden="true">${escape_html(feature.icon)}</div> <div><h3 class="text-xl font-semibold text-headline mb-2">${escape_html(feature.title)}</h3> <p class="text-description leading-relaxed">${escape_html(feature.description)}</p></div></div>`);
          },
          $$slots: { default: true }
        });
      }
      $$renderer3.push(`<!--]--></div></div></section> <section class="py-24 border-t border-border"><div class="mx-auto max-w-7xl"><div class="text-center mb-16"><h2 class="text-3xl font-bold text-headline mb-4 sm:text-4xl">Components</h2> <p class="text-lg text-description">Interactive examples of our most popular components</p></div> <div class="space-y-8">`);
...
<Button variant="brand">Brand Button</Button>`,
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full flex flex-wrap gap-4 items-center justify-center">`);
          Button($$renderer4, { variant: "primary", size: "lg", text: "Primary" });
          $$renderer4.push(`<!----> `);
          Button($$renderer4, { variant: "secondary", size: "md", text: "Secondary" });
          $$renderer4.push(`<!----> `);
          Button($$renderer4, { variant: "danger", size: "sm", text: "Danger" });
          $$renderer4.push(`<!----> `);
...
<Card variant="flat">
  ...
  <CardContent>
    This card indicates an error state.
        ...
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full grid grid-cols-1 md:grid-cols-2 gap-4">`);
          Card($$renderer4, {
            fullWidth: true,
            children: ($$renderer5) => {
              ...
              CardContent($$renderer5, {
                children: ($$renderer6) => {
                  $$renderer6.push(`<p class="text-description">This is a default card with clean styling.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
          ...
          Card($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              CardContent($$renderer5, {
                children: ($$renderer6) => {
                  $$renderer6.push(`<p class="text-description">This card indicates a successful action.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
          ...
          Card($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              CardContent($$renderer5, {
                children: ($$renderer6) => {
                  $$renderer6.push(`<p class="text-description">This card shows a warning state.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
          ...
          Card($$renderer4, {
            ...
            children: ($$renderer5) => {
              ...
              CardContent($$renderer5, {
                children: ($$renderer6) => {
                  $$renderer6.push(`<p class="text-description">This card indicates an error state.</p>`);
                },
                $$slots: { default: true }
              });
              $$renderer5.push(`<!---->`);
...
/>`,
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="space-y-4 max-w-md min-w-[250px]">`);
          Input($$renderer4, {
            label: "Name",
            placeholder: "Enter your name",
            variant: "default"
...
<Badge variant="success" size="lg" text="Large" />`,
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full space-y-4"><div class="flex flex-wrap gap-3 items-center">`);
          Badge($$renderer4, { variant: "default", text: "Default" });
          $$renderer4.push(`<!----> `);
          ...
          $$renderer4.push(`<!----> `);
          Badge($$renderer4, { variant: "neutral", text: "Neutral" });
          $$renderer4.push(`<!----> `);
          Badge($$renderer4, { variant: "energetic", text: "Energetic" });
          $$renderer4.push(`<!----></div> <div class="flex flex-wrap gap-3 items-center">`);
          Badge($$renderer4, { variant: "success", size: "sm", text: "Small" });
          $$renderer4.push(`<!----> `);
          Badge($$renderer4, { variant: "success", size: "md", text: "Medium" });
          $$renderer4.push(`<!----> `);
          Badge($$renderer4, { variant: "success", size: "lg", text: "Large" });
...
<Checkbox label="Disabled checkbox" checked={true} disabled={true} />`,
        children: ($$renderer4) => {
          ...
          $$renderer4.push(`<!----> `);
          Checkbox($$renderer4, { label: "Subscribe to newsletter" });
          $$renderer4.push(`<!----> `);
          Checkbox($$renderer4, { label: "Disabled checkbox", checked: true, disabled: true });
          $$renderer4.push(`<!----></div>`);
        },
        $$slots: { default: true }
      });
...
<Progress value={90} max={100} size="lg" label="Upload Progress" />`,
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full space-y-6 max-w-md min-w-[250px]">`);
          Progress($$renderer4, { value: progressValue, max: 100, label: "Loading" });
          $$renderer4.push(`<!----> `);
          Progress($$renderer4, { value: 75, max: 100, size: "sm" });
          $$renderer4.push(`<!----> `);
          Progress($$renderer4, { value: 90, max: 100, size: "lg", label: "Upload Progress" });
          $$renderer4.push(`<!----></div>`);
        },
        $$slots: { default: true }
      });
...
<Toggle label="Disabled toggle" checked={false} disabled={true} />`,
        children: ($$renderer4) => {
          ...
          $$renderer4.push(`<!----> `);
          Toggle($$renderer4, { label: "Dark mode", checked: true });
          $$renderer4.push(`<!----> `);
          Toggle($$renderer4, { label: "Disabled toggle", checked: false, disabled: true });
          $$renderer4.push(`<!----></div>`);
        },
        $$slots: { default: true }
      });
  ...
  {/snippet}
        ...
        children: ($$renderer4) => {
          ...
          {
            let children = function($$renderer5, { activeTab: activeTab2 }) {
              if (activeTab2 === "tab1") {
                $$renderer5.push("<!--[-->");
                Card($$renderer5, {
                  size: "sm",
                  fullWidth: true,
                  children: ($$renderer6) => {
                    $$renderer6.push(`<p class="text-body">This is the overview tab
                ...
                if (activeTab2 === "tab2") {
                  ...
                  Card($$renderer5, {
                    ...
                    fullWidth: true,
                    children: ($$renderer6) => {
                      $$renderer6.push(`<p class="text-body">Features tab content. Navigate
                  ...
                  if (activeTab2 === "tab3") {
                    ...
                    Card($$renderer5, {
                      ...
                      fullWidth: true,
                      children: ($$renderer6) => {
                        $$renderer6.push(`<p class="text-body">Documentation tab content. All
...
<Modal isOpen={modalOpen} title="Example Modal" size="md">
  ...
  {/snippet}
        ...
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full flex justify-center">`);
          Button($$renderer4, { variant: "primary", onclick: openModal, text: "Open Modal" });
          $$renderer4.push(`<!----> `);
          {
            let footer = function($$renderer5) {
              Button($$renderer5, { variant: "secondary", onclick: closeModal, text: "Cancel" });
              $$renderer5.push(`<!----> `);
              Button($$renderer5, { variant: "primary", onclick: closeModal, text: "Confirm" });
              $$renderer5.push(`<!---->`);
            };
            Modal($$renderer4, {
              isOpen: modalOpen,
              ...
              footer,
              children: ($$renderer5) => {
                $$renderer5.push(`<p class="text-body mb-4">This is a modal dialog. Click outside or
        ...
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full">`);
          {
            ...
            Dropdown($$renderer4, {
              ...
              trigger,
              children: ($$renderer5) => {
                $$renderer5.push(`<div class="px-2 py-2"><button class="w-full text-left px-4 py-2 text-body hover:bg-base-100 rounded-md transition-colors">Option 1</button> <button class="w-full text-left px-4 py-2 text-body hover:bg-base-100 rounded-md transition-colors">Option 2</button> <button class="w-full text-left px-4 py-2 text-body hover:bg-base-100 rounded-md transition-colors">Option 3</button></div>`);
              },
  ...
  <Button variant="ghost" text="Hover me" />
        ...
        children: ($$renderer4) => {
          ...
          Tooltip($$renderer4, {
            ...
            placement: "right",
            children: ($$renderer5) => {
              Button($$renderer5, { variant: "secondary", text: "Hover me" });
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!----> `);
          Tooltip($$renderer4, {
            ...
            placement: "bottom",
            children: ($$renderer5) => {
              Button($$renderer5, { variant: "ghost", text: "Hover me" });
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!----> `);
          Tooltip($$renderer4, {
            ...
            placement: "left",
            children: ($$renderer5) => {
              Button($$renderer5, { variant: "primary", text: "Hover me" });
            },
            $$slots: { default: true }
          });
          $$renderer4.push(`<!----></div>`);
...
<div class="space-y-3">
  ...
  <Skeleton width="70%" height="1rem" />
        ...
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full space-y-4"><div class="space-y-2">`);
          Skeleton($$renderer4, { width: "100%", height: "1rem" });
          $$renderer4.push(`<!----> `);
          Skeleton($$renderer4, { width: "80%", height: "1rem" });
          $$renderer4.push(`<!----> `);
          Skeleton($$renderer4, { width: "60%", height: "1rem" });
          $$renderer4.push(`<!----></div> `);
          Card($$renderer4, {
            size: "sm",
            fullWidth: true,
            children: ($$renderer5) => {
              ...
              Skeleton($$renderer5, { width: "100%", height: "200px" });
              $$renderer5.push(`<!----> `);
              Skeleton($$renderer5, { width: "100%", height: "1rem" });
              $$renderer5.push(`<!----> `);
              Skeleton($$renderer5, { width: "70%", height: "1rem" });
              $$renderer5.push(`<!----></div>`);
            },
            $$slots: { default: true }
          });
...
/>`,
        children: ($$renderer4) => {
          $$renderer4.push(`<div class="w-full overflow-x-auto"><div class="min-w-[280px]">`);
          SidebarNavigation($$renderer4, {
            ...
            get isLightMode() {
              return sidebarLightMode;
            },
            set isLightMode($$value) {
              sidebarLightMode = $$value;
              $$settled = false;
            },
            get searchValue() {
      ...
      $$renderer3.push(`<!----></div> <div class="text-center mt-16">`);
      Button($$renderer3, {
        variant: "outline",
        size: "lg",
        onclick: () => goto(),
