import { o as te, K as ae, L as re, M as oe, S as ne, p as b, f as _, a as A, q as j, b as s, c as G, d as V, r as Y, w as M, h as r, i as S, g as N, v as F, I as R, y as x, H as I, D, t as E, C as U, B as P, F as ie, G as se, z as W, N as K, e as Z, s as $, E as ee, x as le } from "../props-BKbHJRuR.js";
import { f as J, h as de, B as H, e as ce, I as Q, T as ve, C as ue } from "../CodeBlock-Bbv6JfD2.js";
function X(t, e) {
...
function me(t = {}, e, a, o) {
  return te(() => {
    ...
    return ae(() => {
      i = n, n = [], oe(() => {
        t !== a(...n) && (e(t, ...n), i && X(a(...i), t) && e(null, ...i));
      });
    }), () => {
      re(() => {
        n && X(a(...n), t) && e(null, ...n);
...
function be(t, e) {
  V(e, !0);
  let a = b(e, "method", 3, "post"), o = b(e, "action", 3, ""), i = b(e, "className", 3, ""), n = Y(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "method",
...
function rt(t, e) {
  J(t, we);
  let a = b(e, "variant", 3, "main"), o = b(e, "gap", 3, "md"), i = b(e, "className", 3, ""), n = Y(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "variant",
...
function ot(t, e) {
  ...
  var n = I(), g = R(n);
  {
    var c = (d) => {
      var u = qe();
      u.__click = [ye, i], u.__keydown = [_e, i];
...
function it(t, e) {
  ...
  var g = x(n, 2);
  {
    var c = (d) => {
      var u = Me(), h = r(u);
      j(h, () => e.children ?? M), s(d, u);
    };
    S(g, (d) => {
      a() && d(c);
    });
  }
  E(() => P(i, "data-placement", o())), s(t, i);
}
function Be(t, e, a, o) {
...
var Ee = (t, e, a) => e(N(a).id), Re = _('<button type="button" role="tab"> </button>'), Ue = _('<div class="tabs-container"><div class="flex border-b border-gray-200" role="tablist" tabindex="0"></div> <div class="mt-4"><!></div></div>');
function st(t, e) {
  V(e, !0);
...
function lt(t, e) {
  ...
  })), u = F(() => a() === "success" || a() === "info" ? "status" : "alert"), h = F(() => ({
  ...
  var m = Fe();
  A(m, () => ({
    class: `relative rounded-md p-4 border ${N(d)[a()] ?? ""} transition-all duration-200 motion-reduce:transition-none ${g() ?? ""}`,
    role: N(u),
  ...
  var O = x(L, 2);
  j(O, () => e.children ?? M), E(() => W(p, 1, `flex items-start gap-3 ${n() ? "pr-8" : ""}`)), s(t, m);
}
D(["click"]);
function Ie(t, e) {
  const a = t.target;
...
function dt(t, e) {
  ...
  var k = x(h, 2);
  k.__change = [Ie, a], me(k, (p) => $(g, p), () => N(g)), E(() => P(k, "accept", i())), s(t, u);
}
D(["click", "keydown", "change"]);
var Ge = _('<p class="text-sm text-text-secondary mt-1"> </p>'), Ve = (t, e) => $(e, !N(e)), We = ee('<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg> Preview', 1), Je = ee('<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 20l4-16m4 4l4 4-4 4M6 16l-4-4 4-4"></path></svg> Code', 1), Qe = _('<div class="component-preview svelte-1uavm9q"><!></div>'), Xe = _('<div><div class="px-6 py-4 border-b border-border bg-surface-secondary"><div class="flex items-center justify-between"><div><h3 class="text-lg font-semibold text-text"> </h3> <!></div> <button class="flex items-center gap-2 px-3 py-1.5 text-sm text-text-secondary hover:text-text hover:bg-surface rounded-md transition-colors duration-200"><!></button></div></div> <div class="p-6"><!></div></div>');
const Ze = {
  hash: "svelte-1uavm9q",
...
function ct(t, e) {
  J(t, Ze);
  let a = b(e, "description", 3, ""), o = b(e, "language", 3, "svelte"), i = b(e, "className", 3, ""), n = Y(e, [
    "$$slots",
    "$$events",
    "$$legacy",
    "title",
  ...
  var d = r(c), u = r(d), h = r(u), m = r(h), f = r(m), k = x(m, 2);
  {
    var p = (l) => {
      var C = Ge(), T = r(C);
      E(() => U(T, a())), s(l, C);
  ...
  E(() => {
    U(f, e.title), P(w, "aria-label", N(g) ? "Show preview" : "Show code");
  }), s(t, c);
}
D(["click"]);
...
function vt(t, e) {
  ...
  function i(c) {
    const d = new FormData(c.target), u = {
      name: d.get("name") || "",
      email: d.get("email") || "",
      message: d.get("message") || "",
      subscribe: d.get("subscribe") === "on" || !1
    };
  ...
  be(g, {
    ...
    $$slots: { default: !0 }
  }), E(() => W(n, 1, `max-w-md mx-auto ${a() ?? ""}`)), s(t, n), G();
}
export {
  lt as Alert,
  ct as ComponentDemo,
