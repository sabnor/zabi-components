  ...
  {/snippet}
        ...
        organisms: [
            ...
            },
            {
                ...
                category: "organisms",
                description:
                    "The chrome of a sidebar with the regions left open: width, surface, collapse behaviour and a scrolling middle. Compose SidebarBrandHeader, SidebarNavSection and SidebarFooter into it when SidebarNavigation's fixed shape is not yours.",
                props: [
                    {
                        name: "mode",
                        type: "'expanded' | 'collapsed'",
