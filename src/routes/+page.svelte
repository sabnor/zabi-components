...
<section class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-8">
        <div>
            ...
            <p class="text-lg text-secondary">
                A collection of reusable Svelte components built with Tailwind
                CSS and TypeScript, featuring comprehensive scales with light
    ...
    <div class="space-y-8 mb-12">
        <div class="flex justify-between items-center">
            ...
            <Button on:click={() => (showScaleDemo = true)} variant="outline">
                View Scale Demo
            </Button>
        </div>
        <p class="text-secondary">
            Comprehensive Tailwind scales supporting both light and dark modes.
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div class="card p-4">
                ...
                <div class="flex space-x-1">
                    ...
                    <div class="w-4 h-4 bg-error-500 rounded"></div>
                </div>
            </div>
            <div class="card p-4">
                <h3 class="text-lg font-semibold text-primary mb-2">
                ...
                <p class="text-secondary text-sm mb-3">
                    Extended typography scale from 2xs to 9xl with proper line
                    heights.
                </p>
                <div class="space-y-1">
    ...
    <div class="space-y-8 mb-12">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div class="space-y-4">
                    ...
                    <Select
                        ...
                        label="Select Option"
                    />
                    <ColorPicker bind:value={colorValue} label="Color Picker" />
                    <TextAlignment
                ...
                <div class="space-y-4">
                    ...
                    />
                    <Toggle bind:checked={toggleValue} label="Toggle Switch" />
                    <div class="p-4 border rounded-lg">
                        <h4 class="font-medium mb-2">Selected Values:</h4>
                        <p class="text-sm text-gray-600">Input: {inputValue}</p>
                        ...
                        <p class="text-sm text-gray-600">Color: {colorValue}</p>
                        <p class="text-sm text-gray-600">
        ...
        <!-- Skeleton -->
        <div class="space-y-4">
            <h3 class="text-lg font-medium text-gray-700">Skeleton Loading</h3>
            <div class="space-y-2">
        ...
        <!-- Optimized Image -->
        <div class="space-y-4">
            <h3 class="text-lg font-medium text-gray-700">Optimized Image</h3>
            <OptimizedImage
                src="/vite.svg"
                alt="Vite Logo"
                width="100"
    ...
    <div class="space-y-8 mb-12">
        ...
        <div class="space-y-4">
            ...
            <Button on:click={() => (showSlideUp = true)}>Open Slide Up</Button>
    ...
    <!-- Performance Monitor -->
    <div class="space-y-4">
        <h3 class="text-lg font-medium text-primary">Performance Monitor</h3>
        <PerformanceMonitor />
    </div>
    ...
    {#if showScaleDemo}
        ...
        >
            <div
                class="bg-surface-primary rounded-lg shadow-adaptive-xl max-w-7xl w-full max-h-[90vh] overflow-hidden"
            >
                <div
