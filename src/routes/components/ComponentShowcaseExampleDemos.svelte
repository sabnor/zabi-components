    ...
    {#each component.examples as example, exampleIndex (example.title)}
        ...
        >
                ...
                <div class="space-y-4">
                    <div class="flex flex-wrap gap-4 items-center">
                        ...
                        <div class="flex flex-col items-center gap-1">
                            ...
                            <IconButton variant="danger" label="Remove">
                                <Heart />
                            </IconButton>
                        </div>
                    </div>
                    <div class="flex flex-wrap gap-4 items-center">
                        <IconButton variant="primary" disabled label="Favorite">
                            <Heart />
                        </IconButton>
                        <IconButton
                            variant="secondary"
            ...
            {:else if component.name === "Modal"}
                <div class="space-y-4">
                    <Button
                        ...
                        text="Open Modal"
                    />
                    <Modal bind:isOpen={modalOpen} title="Example Modal">
                        <p class="text-description mb-4">
                            This is a modal dialog with some content.
                        </p>
            ...
            {:else if component.name === "SlideUp"}
                <div class="space-y-4">
                    <Button
                        onclick={() => (slideUpOpen = true)}
                        text="Open Slide Up"
                    />
                    <SlideUp bind:isOpen={slideUpOpen} title="Slide Up Panel">
                        <div class="p-6">
                            <h3
                            ...
                            <p class="text-description mb-4">
                                This is a slide-up panel with custom content.
                            </p>
                            <Button
            ...
            {:else if component.name === "NavigationMenu"}
                <div class="space-y-6">
                    <div>
                        <h4 class="text-sm font-medium text-headline mb-4">
                            Data-Driven API
                        </h4>
                        <NavigationMenu
                            items={[
                        ...
                        <NavigationMenu>
                            <NavigationMenuList>
                                <NavigationMenuItem value="home">
                                    <NavigationMenuTrigger value="home"
                        ...
                        <NavigationMenu>
                            <NavigationMenuList>
                                <NavigationMenuItem value="status">
                                    <NavigationMenuTrigger value="status"
            ...
            {:else if component.name === "SidebarNavigation"}
                <div class="space-y-10">
                    ...
                    >
                        ...
                        <p
                            class="mb-3 text-sm leading-relaxed text-description"
                        >
                            The organism composes smaller pieces from this
                            library plus icons. Section headings and grouped
                            lists come from
                            <strong class="text-headline"
                                >SidebarNavSection</strong
                            >; optional logo + wordmark from
                            <strong class="text-headline"
                                >SidebarBrandHeader</strong
                            >. Row badges use
                            <a
                            ...
                            <a
                                ...
                                >Input</a
                            >
                            (or a search trigger button). For “pick a workspace”
                            flows, pair the rail with
                            <a
                        ...
                        >
                            <li>
                                <span class="font-medium text-headline"
                                    >Molecules</span
                                >
                                —
                                <code class="text-xs font-mono"
                                    >SidebarBrandHeader</code
                                >,
                                <code class="text-xs font-mono"
                                    >SidebarNavSection</code
                                >
                            </li>
                            <li>
                                <span class="font-medium text-headline"
                            ...
                            <li>
                                ...
                                <code class="text-xs font-mono"
                                    >@lucide/svelte</code
                                > (e.g. Search, LogOut, Sun, Moon)
                            </li>
                        </ul>
                    </section>

                    <div>
                        <h4 class="mb-1 text-sm font-medium text-headline">
                            Realistic app shell
                        </h4>
                        <p
                            class="mb-4 text-sm leading-relaxed text-description"
                        >
                            A compact product layout: floating sidebar rail (<code
                                class="font-mono text-xs">layout="card"</code
                            >), brand row, grouped primary nav, footer profile +
                            logout + theme, and a main column where your routed
                        ...
                        >
                            {#snippet appShellProfilePanel()}
                                <SidebarAccountPanel
                                    ...
                                    onLogout={() =>
                                        (appShellAccountPanelOpen = false)}
                                    onAccount={() =>
                                        (appShellAccountPanelOpen = false)}
                                    onClose={() =>
                                        (appShellAccountPanelOpen = false)}
                            ...
                            >
                                ...
                                >
                                    ...
                                    <Badge variant="info" text="Demo preview" />
                                </header>
                                    ...
                                    <Card>
                                        ...
                                        <CardContent>
                                            <p class="text-sm text-description">
                                                Cards, tables, or charts would
                                                live here—whatever the selected
                                                nav item loads in a real
                                                SvelteKit
            ...
            {:else if component.name === "ColorPicker"}
                <div class="w-full space-y-6">
                    ...
                    <ColorPicker value="#3b82f6" label="Background Color" />
                    <ColorPicker disabled={true} label="Disabled Picker" />
                </div>
            ...
            {:else if component.name === "Checkbox"}
                <div class="w-full space-y-4">
                    ...
                    <Checkbox label="Email verified" checked={true} />
                    <Checkbox label="Review required" />
                    <Checkbox disabled={true} label="Disabled option" />
                </div>
            ...
            {:else if component.name === "Heading"}
                <div class="space-y-4">
                    <Heading level={1} text="Display Heading" />
                    <Heading level={2} text="Section Heading" />
                    <Heading level={3} text="Subtitle Heading" />
                    ...
                    <div class="w-full space-y-4">
                        ...
                        >
                            ...
                            <Toast
                                ...
                                type="warning"
                            />
                            <Toast layout="inline" message="Info" type="info" />
                        </div>
                    </div>
                {/if}
            ...
            {:else if component.name === "CardHeader" || component.name === "CardContent" || component.name === "CardFooter"}
                <div class="">
                    <Card>
                        ...
                        <CardFooter>
                            <Button variant="outline" text="Manage members" />
                        </CardFooter>
                    </Card>
                </div>
            ...
            {:else if component.name === "Text"}
                <Text tone="headline" size="lg">Headline style</Text>
            ...
            {:else if component.name === "Section"}
                <Section title="Highlights" background="muted" padding="md">
                    <p class="text-sm text-body">
                        Section provides titled bands with background and
                        spacing presets.
                    </p>
                </Section>
            {:else if ["NavigationMenuList", "NavigationMenuItem", "NavigationMenuTrigger", "NavigationMenuContent", "NavigationMenuLink"].includes(component.name)}
                <div class="min-w-0 overflow-x-auto py-2">
                    ...
                    >
                        <NavigationMenuList>
                            <NavigationMenuItem value="docs">
                                <NavigationMenuTrigger value="docs"
                                    >Docs</NavigationMenuTrigger
                                >
                                <NavigationMenuContent value="docs">
                                    <ul class="grid min-w-[12rem] gap-2 p-3">
                                        <li>
            ...
            {:else if component.name === "SidebarBrandHeader"}
                <div class="w-64 rounded-xl border border-border bg-card p-3">
                    <SidebarBrandHeader brandName="Zabi" />
                </div>
            {:else if component.name === "SidebarFooter"}
                <div class="w-64 rounded-xl border border-border bg-card">
                    <SidebarFooter
                        collapsed={false}
                        profileName="Alex Rivera"
                    />
            ...
            {:else if component.name === "SidebarNavSection"}
                <div class="w-64 rounded-xl border border-border bg-card p-2">
                    <SidebarNavSection
                        title="Workspace"
                        listAriaLabel="Workspace navigation"
                    >
                        <li class="rounded-md px-2 py-1.5 text-sm text-body">
                            Overview
                        </li>
                        <li class="rounded-md px-2 py-1.5 text-sm text-body">
                            Settings
            ...
            {:else if component.name === "Tooltip"}
                <div class="flex gap-4 items-center">
                    ...
                    <Tooltip content="Bottom tooltip" placement="bottom">
                        <Button variant="ghost" text="Bottom" />
                    </Tooltip>
                </div>
            {/if}
        </ComponentDemo>
